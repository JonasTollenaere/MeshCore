...
__device__
CudaRay::CudaRay(Vertex origin, Vertex direction): origin(origin), direction(direction)
{
...
__device__
void CudaRay::transform(const Transformation& transformation) {
